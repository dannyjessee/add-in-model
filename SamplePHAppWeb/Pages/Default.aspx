<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SamplePHAppWeb.Default" %>
        ...
        <div>
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="View1" runat="server">
                    ...
                    <asp:CheckBox ID="chkAppOnly" runat="server" /> Use App-only Authorization Policy
                    <h2>App Web</h2>
                    List Name:
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <asp:CheckBox ID="chkAppOnlyREST" runat="server" /> Use App-only Authorization Policy
                    <h2>App Web</h2>
                    List Name:
